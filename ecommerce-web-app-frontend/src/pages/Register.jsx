...
function Register() {
  return (
    <>
      <form className="flex justify-center items-center pt-[150px] md:pt-[100px] md:pb[100px] pb-[150px]">
        <div className="p-10 border-b border-black dark:border-white rounded-lg shadow w-[500px]">
